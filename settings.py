...
WSN_ASG = '12_LP1_WSNASG2_D7001D_%s' % user
WSN_LC = '12_LP1_WSNLC2_D7001D_%s' % user
...
FRONTEND_ASG = '12_LP1_FRONTENDASG2_D7001D_%s' % user
FRONTEND_LC = '12_LP1_FRONTENDLC2_D7001D_%s' % user
